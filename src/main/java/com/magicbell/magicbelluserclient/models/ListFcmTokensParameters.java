...
@EqualsAndHashCode
@Jacksonized
public class ListFcmTokensParameters {
  ...
  public static class ListFcmTokensParametersBuilder {

    private JsonNullable<Long> limit = JsonNullable.undefined();

    @JsonProperty("limit")
    public ListFcmTokensParametersBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("starting_after")
    public ListFcmTokensParametersBuilder startingAfter(String value) {
      if (value == null) {
    ...
    @JsonProperty("ending_before")
    public ListFcmTokensParametersBuilder endingBefore(String value) {
      if (value == null) {
