...
@EqualsAndHashCode
@Jacksonized
public class ListExpoTokensParameters {
  ...
  public static class ListExpoTokensParametersBuilder {

    private JsonNullable<Long> limit = JsonNullable.undefined();

    @JsonProperty("limit")
    public ListExpoTokensParametersBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("starting_after")
    public ListExpoTokensParametersBuilder startingAfter(String value) {
      if (value == null) {
    ...
    @JsonProperty("ending_before")
    public ListExpoTokensParametersBuilder endingBefore(String value) {
      if (value == null) {
