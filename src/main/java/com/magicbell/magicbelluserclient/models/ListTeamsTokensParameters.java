...
@EqualsAndHashCode
@Jacksonized
public class ListTeamsTokensParameters {
  ...
  public static class ListTeamsTokensParametersBuilder {

    private JsonNullable<Long> limit = JsonNullable.undefined();

    @JsonProperty("limit")
    public ListTeamsTokensParametersBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("starting_after")
    public ListTeamsTokensParametersBuilder startingAfter(String value) {
      if (value == null) {
    ...
    @JsonProperty("ending_before")
    public ListTeamsTokensParametersBuilder endingBefore(String value) {
      if (value == null) {
