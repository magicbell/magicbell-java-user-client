...
@EqualsAndHashCode
@Jacksonized
public class ListMagicbellSlackbotTokensParameters {
  ...
  public static class ListMagicbellSlackbotTokensParametersBuilder {

    private JsonNullable<Long> limit = JsonNullable.undefined();

    @JsonProperty("limit")
    public ListMagicbellSlackbotTokensParametersBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("starting_after")
    public ListMagicbellSlackbotTokensParametersBuilder startingAfter(String value) {
      if (value == null) {
    ...
    @JsonProperty("ending_before")
    public ListMagicbellSlackbotTokensParametersBuilder endingBefore(String value) {
      if (value == null) {
