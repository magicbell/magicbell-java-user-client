...
@EqualsAndHashCode
@Jacksonized
public class ArchiveAllNotificationsParameters {
  ...
  public static class ArchiveAllNotificationsParametersBuilder {

    private JsonNullable<String> category = JsonNullable.undefined();

    @JsonProperty("category")
    public ArchiveAllNotificationsParametersBuilder category(String value) {
      if (value == null) {
    ...
    @JsonProperty("topic")
    public ArchiveAllNotificationsParametersBuilder topic(String value) {
      if (value == null) {
