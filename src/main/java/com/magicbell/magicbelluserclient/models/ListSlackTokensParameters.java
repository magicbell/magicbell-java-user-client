...
@EqualsAndHashCode
@Jacksonized
public class ListSlackTokensParameters {
  ...
  public static class ListSlackTokensParametersBuilder {

    private JsonNullable<Long> limit = JsonNullable.undefined();

    @JsonProperty("limit")
    public ListSlackTokensParametersBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("starting_after")
    public ListSlackTokensParametersBuilder startingAfter(String value) {
      if (value == null) {
    ...
    @JsonProperty("ending_before")
    public ListSlackTokensParametersBuilder endingBefore(String value) {
      if (value == null) {
