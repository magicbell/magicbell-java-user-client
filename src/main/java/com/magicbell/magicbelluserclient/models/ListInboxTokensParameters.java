...
@EqualsAndHashCode
@Jacksonized
public class ListInboxTokensParameters {
  ...
  public static class ListInboxTokensParametersBuilder {

    private JsonNullable<Long> limit = JsonNullable.undefined();

    @JsonProperty("limit")
    public ListInboxTokensParametersBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("starting_after")
    public ListInboxTokensParametersBuilder startingAfter(String value) {
      if (value == null) {
    ...
    @JsonProperty("ending_before")
    public ListInboxTokensParametersBuilder endingBefore(String value) {
      if (value == null) {
