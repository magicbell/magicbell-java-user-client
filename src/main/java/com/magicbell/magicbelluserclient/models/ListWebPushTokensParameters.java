...
@EqualsAndHashCode
@Jacksonized
public class ListWebPushTokensParameters {
  ...
  public static class ListWebPushTokensParametersBuilder {

    private JsonNullable<Long> limit = JsonNullable.undefined();

    @JsonProperty("limit")
    public ListWebPushTokensParametersBuilder limit(Long value) {
      if (value == null) {
    ...
    @JsonProperty("starting_after")
    public ListWebPushTokensParametersBuilder startingAfter(String value) {
      if (value == null) {
    ...
    @JsonProperty("ending_before")
    public ListWebPushTokensParametersBuilder endingBefore(String value) {
      if (value == null) {
