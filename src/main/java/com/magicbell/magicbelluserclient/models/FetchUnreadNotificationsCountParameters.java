...
@EqualsAndHashCode
@Jacksonized
public class FetchUnreadNotificationsCountParameters {
  ...
  public static class FetchUnreadNotificationsCountParametersBuilder {

    private JsonNullable<String> category = JsonNullable.undefined();

    @JsonProperty("category")
    public FetchUnreadNotificationsCountParametersBuilder category(String value) {
      if (value == null) {
    ...
    @JsonProperty("topic")
    public FetchUnreadNotificationsCountParametersBuilder topic(String value) {
      if (value == null) {
