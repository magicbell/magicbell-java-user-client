# MagicbellJavaUserClient Java SDK 0.1.3
...
```XML
<dependency>
    <groupId>com.magicbell.user_client</groupId>
...
```Gradle
implementation group: com.magicbell.user_client, name: magicbell-java-user-client, version: 0.1.3
```
